...
public class KNNTrainingDataSet {
	...
	public ArrayList<KNNTrainingData> examples;

	public KNNTrainingDataSet(int numInputs, int numOuputs, ArrayList<Integer> possibleOutputs, String dateFormat) {
		...
		this.examples = new ArrayList<KNNTrainingData>();
	}
	...
	public void addExampleFromLine(String line) {
		...
		try {
			...
			KNNTrainingData example = new KNNTrainingData(timeStamp, inputs, classe);
